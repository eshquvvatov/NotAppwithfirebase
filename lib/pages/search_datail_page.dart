...
class SearchDetailPage extends StatefulWidget {
  ...
  SearchDetailPage({Key? key, required this.oblect,required this.text}) : super(key: key);
...
class _SearchDetailPageState extends State<SearchDetailPage> {
  ...
  void loadData() async {
    ...
    await NetworkService.GET(
        NetworkService.API_POST_SEARCH_LIST, NetworkService.paramsSearch(widget.text,_countLoadMore))
        .then((value) {
      savaData(value);
    });
  }
              ...
              children: [
                ...
                MasonryGridView.count(
                  ...
                  itemBuilder: (context, index) {
                    return ScrolImage(
                      image: painterisOblects[index],search:widget.text,
                    );
                  },
                ),
              ],
