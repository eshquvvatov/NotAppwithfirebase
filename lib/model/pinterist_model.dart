...
//
//     final painteris = painterisFromJson(jsonString);

import 'dart:convert';

// List<PainterisOblect> painterisFromJson(String str) => List<PainterisOblect>.from(json.decode(str).map((x) =>
//     PainterisOblect.fromJson(x)));
//
// String painterisToJson(List<PainterisOblect> data) => json.encode(List<dynamic>.from(data.map((x) =>
//     x.toJson())));

class PainterisOblectList{
  late List<PainterisOblect> painterisOblectList;

  PainterisOblectList();
  PainterisOblectList.fromJson(List json) {
    painterisOblectList = json.map((map) => PainterisOblect.fromJson(map)).toList();
  }

  List toJson() {
    List list;
    list = painterisOblectList.map((user) => user.toJson()).toList();
    return list;
  }
}

class PainterisOblect {
  PainterisOblect({
    this.id,
    this.createdAt,
    this.updatedAt,
  ...
  factory PainterisOblect.fromJson(Map<String, dynamic> json) => PainterisOblect(
    id: json["id"],
    ...
    links: PainterisLinks.fromJson(json["links"]),
...
class PainterisLinks {
  ...
  factory PainterisLinks.fromJson(Map<String, dynamic> json) => PainterisLinks(
    self: json["self"],
    html: json["html"],
...
class TopicSubmissions {
  ...
  factory TopicSubmissions.fromJson(Map<String, dynamic> json) => TopicSubmissions(
    ...
    entrepreneur: json["entrepreneur"] == null ? null : BusinessWork.fromJson(json["entrepreneur"]),
